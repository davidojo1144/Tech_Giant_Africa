        ...
        <div className='flex md:flex-row flex-col items-center justify-between gap-10  mt-10 border-2 border-gray-400 shadow-2xl md:p-10 p-3'>
            <div className='text-white md:space-y-8 space-y-3'>
                ...
                <div className='flex gap-5'>
                    <button className='py-2 px-5 bg-gray-200 hover:bg-gray-300 text-gray-700 hover:text-gray-800 rounded'>Get a Free Quote</button>
                    <button className='py-2 px-5 bg-gray-200 hover:bg-gray-300 text-gray-700 hover:text-gray-800 rounded'>View Our Portfolio</button>
                </div>
            </div>
            <img className='md:w-[40%] rounded' src={assets.hero} alt="" />
        </div>
    </div>
    </>
  )
